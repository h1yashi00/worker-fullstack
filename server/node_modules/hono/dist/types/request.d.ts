import type { Input, InputToDataByTarget, ParamKeys, ParamKeyToRecord, RemoveQuestion, UndefinedIfHavingQuestion, ValidationTargets } from 'hono/dist/types/types';
...
export declare class HonoRequest<P extends string = '/', I extends Input = {}> {
    raw: Request;
    private paramData;
